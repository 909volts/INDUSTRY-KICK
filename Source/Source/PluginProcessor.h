...
private:
    ...
    {
        bool active=false;
        double phase=0.0,punchPhase=0.0,age=0.0;
        float velocity=1.0f;
        juce::Random random;
    } voice;
    struct Layers { float sub=0,kick=0,punch=0,texture=0,envelope=0; };

    double sampleRate=44100.0;
    int preparedBlockSize=512;
    float splitLow=0,cabinetLP=0,reverbHpX=0,reverbHpY=0;
    ...
    juce::AudioBuffer<float> reverbBuffer,envelopeBuffer;
