...
$ValidationDir = Join-Path $ProjectRoot "Stage72CValidation"
$BundleZip = Join-Path $ProjectRoot "Stage72CValidationBundle.zip"
...
Write-Host "INDUSTRY KICK — Stage 7.2C Robust DSP Freeze / Pre-GUI Gate"
