...
int main()
{
    ...
    // ---------------------------------------------------------------------
    // Stage 9.0: full 250-preset technical pass + objective audit export.
    ...
    // ---------------------------------------------------------------------
    {
        const auto auditDir = juce::File::getCurrentWorkingDirectory().getChildFile("Stage90PresetAudit");
        if (auditDir.exists())
