...
// INDUSTRY KICK V2 — Stage 6.10 RAVE final-tail / measured-headroom candidate
...
// Stage 6.9: measured family headroom.
// Formula: newScale = Stage6.8Scale * 0.78 / max(factoryWorstPrePeak, randomWorstPrePeak).
// No clipping threshold was changed.
mono = (roundSig*0.646326,
        punchSig*0.654434,
        hardSig*0.682907,
