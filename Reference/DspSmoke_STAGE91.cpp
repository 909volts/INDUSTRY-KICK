...
int main()
{
    ...
    // ---------------------------------------------------------------------
    // Stage 9.1: full 250-preset technical pass + objective audit export.
    ...
    // ---------------------------------------------------------------------
    {
        const auto auditDir = juce::File::getCurrentWorkingDirectory().getChildFile("Stage91PresetAudit");
        if (auditDir.exists())
