...
set "PACKAGE=%~dp0"
set "VALID=%PROJECT%\Stage112Validation"
set "BUNDLE=%PROJECT%\Stage112ValidationBundle.zip"
set "BACKUP=%PROJECT%\Checkpoints\Before_Stage11_2"
...
echo INDUSTRY KICK - STAGE 11.2 PRESET BALANCE
echo Targeted spectral rebalance of 8 presets. DSP frozen.
echo.
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%PACKAGE%Tools\ApplyPresetBalanceFix.ps1" > "%VALID%\PresetFix.log" 2>&1
if errorlevel 1 (
  set "PRESET_FIX=FAIL"
  set "FAILURE_CLASS=PRESET"
  set "FAILED_STEP=ApplyPresetBalanceFix.ps1"
  goto :FAIL
)
set "PRESET_FIX=PASS"
call :WriteStatus
...
echo.
echo ================================================================
echo STAGE_11_2_PRESET_BALANCE=PASS
...
echo.
echo ================================================================
echo STAGE_11_2_PRESET_BALANCE=FAIL
